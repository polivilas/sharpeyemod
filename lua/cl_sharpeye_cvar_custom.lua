...
function sharpeye.GetVar( sVarName, opt_bReturnString )
...
function sharpeye.CreateVar( sVarName, sContents, shouldSave, userData )
	CreateClientConVar(sVarName, sContents, shouldSave, userData)
end

function sharpeye.SetVar( sVarName, tContents )
